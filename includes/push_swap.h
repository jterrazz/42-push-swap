...
/*   Updated: 2017/08/06 17:48:37 by jterrazz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			list_reverse_rotate(t_list_int **list,
	char *print, t_todo *todo);
void			list_push(t_list_int **dest,
	t_list_int **src, char *print, t_todo *todo);
...
void			resolver_simple(t_list_int **stack_a, t_list_int **stack_b,
	t_todo *todo);
void			init_todo(t_todo *todo, t_list_int **stack_a,
	t_list_int **stack_b);
void			make_todo(t_list_int **stack_a, t_list_int **stack_b,
	t_todo *todo);
void			place_in_top(t_list_int **stack_a, int index, t_todo *todo,
	char c);
